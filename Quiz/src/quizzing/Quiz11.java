...
public class Quiz11 {
	...
	private void initialize() {
		...
		JLabel lblQuestionHow = new JLabel("Question 10: Search engines?");
		...
		JButton btnYears = new JButton("Yahoo");
		...
		JButton btnYears_1 = new JButton("Bing");
		...
		JButton btnYears_2 = new JButton("Ask Jeeves");
		...
		JButton btnYears_3 = new JButton("Google");
