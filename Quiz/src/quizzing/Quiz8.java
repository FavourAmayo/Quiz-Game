...
public class Quiz8 {
	...
	private void initialize() {
		...
		JLabel lblQuestionHow = new JLabel("Question 7: Most used input device?");
		...
		JButton btnYears = new JButton("Keyboard");
		...
		JButton btnYears_1 = new JButton("Webcam");
		...
		JButton btnYears_2 = new JButton("Microphone");
		...
		JButton btnYears_3 = new JButton("Mouse");
