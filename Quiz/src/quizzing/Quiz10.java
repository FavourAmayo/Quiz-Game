...
public class Quiz10 {
	...
	private void initialize() {
		...
		JLabel lblQuestionHow = new JLabel("Question 9: Types of computers?");
		...
		JButton btnYears = new JButton("Laptop");
		...
		JButton btnYears_1 = new JButton("Supercomputer");
		...
		JButton btnYears_2 = new JButton("Mainframe");
		...
		JButton btnYears_3 = new JButton("Desktop");
