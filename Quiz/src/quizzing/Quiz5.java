...
public class Quiz5 {
	...
	private void initialize() {
		...
		JLabel lblQuestionHow = new JLabel("Question 4: Best city for programmers?");
		...
		JButton btnYears = new JButton("Los Angeles");
		...
		JButton btnYears_1 = new JButton("San Franscisco");
		...
		JButton btnYears_2 = new JButton("New York");
		...
		JButton btnYears_3 = new JButton("Dallas");
